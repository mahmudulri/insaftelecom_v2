...
import 'package:insaftelecom/accounting/controllers/create_account_controller.dart';
...
class _CreateAccountScreenState extends State<CreateAccountScreen> {
  ...
  List<Map<String, String>> get accountTypeOptions => [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                KText(
                  text: languageController.tr('ACCOUNTS'),
  ...
  Widget _buildAccountInfoCard() {
    return _sectionCard(
      ...
      title: languageController.tr('ACCOUNT_INFORMATION'),
      child: Column(
        children: [
  ...
  Widget _buildOfficeDropdown() {
    return Obx(() {
      ...
      final selectedId = formController.selectedOfficeId.value;

      final selectedExists = officeList.any((item) => item.id == selectedId);
            ...
            child: Row(
              children: [
                Container(
                  ...
                  alignment: Alignment.center,
                  decoration: BoxDecoration(
                    color: AppColors.primarycolor2.withOpacity(0.08),
                    borderRadius: BorderRadius.circular(10),
                  ),
                  child: const Icon(
  ...
  Widget _buildAccountTypeDropdown() {
    return Obx(() {
      final selectedValue = formController.selectedAccountType.value;

      final selectedExists = accountTypeOptions.any(
        (item) => item['value'] == selectedValue,
      );

      return DropdownButtonFormField<String>(
        value: selectedValue.isNotEmpty && selectedExists
            ? selectedValue
            : null,
        isExpanded: true,
        icon: const Icon(
