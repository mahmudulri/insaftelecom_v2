...
class OrderListModel {
  ...
  factory OrderListModel.fromJson(Map<String, dynamic> json) => OrderListModel(
    ...
    code: json["code"] == null ? null : int.tryParse(json["code"].toString()),
...
class Order {
  ...
  factory Order.fromJson(Map<String, dynamic> json) => Order(
    ...
    hasWalletSnapshot: json["has_wallet_snapshot"] == null
        ? null
        : json["has_wallet_snapshot"] is bool
        ? json["has_wallet_snapshot"]
        : json["has_wallet_snapshot"].toString().toLowerCase() == "true",
...
class Bundle {
  ...
  final String? requiredCreditAmountToActivateBundle;
  ...
  final dynamic apiProviderId;
  final dynamic apiProviderBundleId;
  final dynamic apiBinding;
  ...
  final dynamic requestedChargeType;
  final dynamic requestedMnp;
  ...
  Bundle({
    ...
    this.buyingPrice,
    this.sellingPrice,
    this.requiredCreditAmountToActivateBundle,
    this.discountAmount,
    this.discountedPrice,
    this.discountType,
    this.discountSourceId,
  ...
  factory Bundle.fromJson(Map<String, dynamic> json) => Bundle(
    ...
    requiredCreditAmountToActivateBundle:
        json["required_credit_amount_to_activate_bundle"] == null
        ? null
        : json["required_credit_amount_to_activate_bundle"].toString(),
    ...
    bundleImageUrl: json["bundle_image_url"] == null
        ? null
        : json["bundle_image_url"].toString(),

    currencyId: json["currency_id"] == null ? null : json["currency_id"],

    expiredDate: json["expired_date"] == null
        ? null
        : DateTime.parse(json["expired_date"].toString()),
    ...
    apiProviderBundleId: json["api_provider_bundle_id"] == null
        ? null
        : json["api_provider_bundle_id"],

    apiBinding: json["api_binding"] == null ? null : json["api_binding"],
    ...
    hasParentComissionGroup: json["has_parent_comission_group"] == null
        ? null
        : json["has_parent_comission_group"] is bool
        ? json["has_parent_comission_group"]
        : json["has_parent_comission_group"].toString().toLowerCase() == "true",

    hasCustomPricing: json["has_custom_pricing"] == null
        ? null
        : json["has_custom_pricing"] is bool
        ? json["has_custom_pricing"]
        : json["has_custom_pricing"].toString().toLowerCase() == "true",

    requestedChargeType: json["requested_charge_type"] == null
        ? null
        : json["requested_charge_type"],

    requestedMnp: json["requested_mnp"] == null ? null : json["requested_mnp"],
  ...
  Map<String, dynamic> toJson() => {
    ...
    "required_credit_amount_to_activate_bundle":
        requiredCreditAmountToActivateBundle,
    "discount_amount": discountAmount,
    "discounted_price": discountedPrice,
    "discount_type": discountType,
    ...
    "performed_by": performedBy,
    "api_provider_id": apiProviderId,
    "api_provider_bundle_id": apiProviderBundleId,
    ...
    "requested_charge_type": requestedChargeType,
    "requested_mnp": requestedMnp,
...
class Service {
  ...
  factory Service.fromJson(Map<String, dynamic> json) => Service(
    ...
    telegramChatId: json["telegram_chat_id"] == null
        ? null
    ...
    inputFormSchema: json["input_form_schema"] == null
        ? null
        : json["input_form_schema"],
  ...
  Map<String, dynamic> toJson() => {
    ...
    "created_at": createdAt?.toIso8601String(),
    "updated_at": updatedAt?.toIso8601String(),
    "input_form_schema": inputFormSchema,
    "performed_by": performedBy,
...
class Company {
  ...
  factory Company.fromJson(Map<String, dynamic> json) => Company(
    ...
    companyCode: json["company_code"] == null
        ? null
...
class ServiceCategory {
  ...
  final dynamic serviceCategorySubTypeId;
  ...
  final dynamic servicecategorysubtype;

  ServiceCategory({
    this.id,
    this.categoryName,
    this.type,
    this.serviceCategorySubTypeId,
  ...
  factory ServiceCategory.fromJson(Map<String, dynamic> json) =>
      ServiceCategory(
        ...
        serviceCategorySubTypeId: json["service_category_sub_type_id"] == null
            ? null
            : json["service_category_sub_type_id"],
        ...
        servicecategorysubtype: json["servicecategorysubtype"] == null
            ? null
            : json["servicecategorysubtype"],
      );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "type": type,
    "service_category_sub_type_id": serviceCategorySubTypeId,
